...
export enum I18nKey {
  ...
  CONFIGURATION$DEVINJP_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$DEVINJP_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$DEVINJP_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$DEVINJP_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
