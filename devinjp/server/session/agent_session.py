...
from devinjp.controller import AgentController
from devinjp.controller.agent import Agent
from devinjp.controller.replay import ReplayManager
from devinjp.controller.state.state import State
from devinjp.core.config import AgentConfig, AppConfig, LLMConfig
from devinjp.core.exceptions import AgentRuntimeUnavailableError
from devinjp.core.logger import OpenHandsLoggerAdapter
from devinjp.core.schema.agent import AgentState
from devinjp.events.action import ChangeAgentStateAction, MessageAction
from devinjp.events.event import Event, EventSource
from devinjp.events.stream import EventStream
from devinjp.integrations.provider import PROVIDER_TOKEN_TYPE, ProviderHandler
from devinjp.integrations.service_types import Repository
from devinjp.memory.memory import Memory
from devinjp.microagent.microagent import BaseMicroAgent
from devinjp.runtime import get_runtime_cls
from devinjp.runtime.base import Runtime
from devinjp.runtime.impl.remote.remote_runtime import RemoteRuntime
from devinjp.security import SecurityAnalyzer, options
from devinjp.storage.files import FileStore
from devinjp.utils.async_utils import EXECUTOR, call_sync_from_async
...
class AgentSession:
    ...
    async def _create_memory(
        ...
        if self.runtime:
            ...
            # loads microagents from repo/.devinjp/microagents
