...
from devinjp.core.message import Message
from devinjp.llm.debug_mixin import DebugMixin
from devinjp.llm.fn_call_converter import (
    STOP_WORDS,
    convert_fncall_messages_to_non_fncall_messages,
    convert_non_fncall_messages_to_fncall_messages,
)
from devinjp.llm.metrics import Metrics
from devinjp.llm.retry_mixin import RetryMixin
            ...
            if mock_function_calling and 'tools' in kwargs:
                messages = convert_fncall_messages_to_non_fncall_messages(
                    ...
                    add_in_context_learning_example=bool(
                        'devinjp-lm' not in self.config.model
                    ),
                )
                kwargs['messages'] = messages
                ...
                if 'devinjp-lm' in self.config.model:
                    # If we don't have this, we might run into issue when serving devinjp-lm
                    # using SGLang
