...
from devinjp.core.logger import LOG_DIR
...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in devinjp, and normally not used. It is documented on the litellm side.
