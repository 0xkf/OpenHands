...
import devinjp
from devinjp.controller.state.task import RootTask
...
from devinjp.events.action.agent import AgentFinishAction
from devinjp.events.event import Event, EventSource
from devinjp.llm.metrics import Metrics
from devinjp.memory.view import View
from devinjp.storage.files import FileStore
from devinjp.storage.locations import get_conversation_agent_state_filename
...
class State:
    ...
    def to_llm_metadata(self, agent_name: str) -> dict:
        return {
            ...
            'trace_version': devinjp.__version__,
            'tags': [
                f'agent:{agent_name}',
                f"web_host:{os.environ.get('WEB_HOST', 'unspecified')}",
                f'devinjp_version:{devinjp.__version__}',
            ],
        }
