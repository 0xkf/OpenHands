...
from devinjp.storage.google_cloud import GoogleCloudFileStore
from devinjp.storage.local import LocalFileStore
from devinjp.storage.memory import InMemoryFileStore
from devinjp.storage.s3 import S3FileStore
