...
from devinjp.core.logger import DEBUG, DEBUG_RUNTIME
from devinjp.core.logger import devinjp_logger as logger
from devinjp.events import EventStream
from devinjp.runtime.builder import DockerRuntimeBuilder
from devinjp.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from devinjp.runtime.impl.docker.containers import stop_all_containers
...
from devinjp.runtime.utils.log_streamer import LogStreamer
from devinjp.runtime.utils.runtime_build import build_runtime_image
from devinjp.utils.async_utils import call_sync_from_async
from devinjp.utils.shutdown_listener import add_shutdown_listener
from devinjp.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'devinjp-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _init_container(self):
        ...
        if (
            ...
            # e.g. result would be: {"/home/user/devinjp/workspace": {'bind': "/workspace", 'mode': 'rw'}}
            volumes = {
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/devinjp/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None):
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'devinjp-sandbox-' prefix
        """
        super().close()
