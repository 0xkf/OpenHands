...
from devinjp.runtime.utils.runtime_build import (
    BuildFromImageType,
    prep_build_folder,
)
...
class ModalRuntime(ActionExecutionClient):
    ...
    container_name_prefix = 'devinjp-sandbox-'
    ...
    def __init__(
        ...
        self.app = modal.App.lookup(
            'devinjp', create_if_missing=True, client=self.modal_client
        )
