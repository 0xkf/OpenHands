...
DEFAULT_PYTHON_PREFIX = [
    '/devinjp/micromamba/bin/micromamba',
    'run',
    '-n',
    'devinjp',
    'poetry',
...
def get_action_execution_server_startup_command(
    ...
    username = override_username or (
        'devinjp' if app_config.run_as_devinjp else 'root'
    )
    user_id = override_user_id or (
        sandbox_config.user_id if app_config.run_as_devinjp else 0
    )
    ...
    base_cmd = [
        *python_prefix,
        ...
        '-u',
        '-m',
        'devinjp.runtime.action_execution_server',
        str(server_port),
        '--working-dir',
