...
from devinjp.events.action import CmdRunAction
from devinjp.events.observation import ErrorObservation
...
class BashSession:
    ...
    def initialize(self) -> None:
        ...
        if self.username in ['root', 'devinjp']:
        ...
        session_name = f'devinjp-{self.username}-{uuid.uuid4()}'
