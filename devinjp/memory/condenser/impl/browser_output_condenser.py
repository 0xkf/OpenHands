...
from devinjp.core.config.condenser_config import BrowserOutputCondenserConfig
...
from devinjp.memory.condenser.condenser import Condensation, Condenser, View
