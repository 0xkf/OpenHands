...
from devinjp.core.message import ImageContent, Message, TextContent
...
from devinjp.events.event import Event, RecallType
...
from devinjp.events.serialization.event import truncate_content
from devinjp.utils.prompt import PromptManager, RepositoryInfo, RuntimeInfo
...
class ConversationMemory:
    ...
    def _process_action(
        ...
        Args:
            action: The action to convert. Can be one of:
                ...
                - FileReadAction: For reading files using devinjp-aci commands
    ...
    def _process_observation(
        ...
        - FileReadObservation: Formats file reading results from devinjp-aci
        ...
        if isinstance(obs, CmdOutputObservation):
            ...
            )  # Content is already truncated by devinjp-aci
